...
print_menu() {
  ...
  log_line "  ${C_CYAN}2${C_RESET}) ${C_BOLD}idont pro${C_RESET}        ${C_DIM}Standard edition (recommended)${C_RESET}"
  log_line "  ${C_YELLOW}3${C_RESET}) ${C_BOLD}idont${C_RESET}     ${C_DIM}Custom brand name, tagline, and logo${C_RESET}"
